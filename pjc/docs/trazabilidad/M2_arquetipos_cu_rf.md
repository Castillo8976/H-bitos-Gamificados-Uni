# Tabla 2 — Arquetipos → CU, RF

**Proyecto:** Plataforma Web Gamificada  
**Sección:** 9.2 Artefactos de Trazabilidad

> Esta matriz confirma que cada arquetipo del sistema está respaldado por al menos un Caso de Uso y un Requisito Funcional documentado.
...
| Sesión de estudio | Gestión académica | CU04 | RF10, RF11, RF12 |
